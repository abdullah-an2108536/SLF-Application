...
public class ViewSlaughterRecordPanel extends JPanel {
	 ...
	 * Create the panel.
	 */
	public ViewSlaughterRecordPanel() {
		...
		JButton submitBTN = new JButton("View Slaughter Records for this Beneficiary");
