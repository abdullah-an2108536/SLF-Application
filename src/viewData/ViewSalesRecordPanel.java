...
public class ViewSalesRecordPanel extends JPanel {
	...
	public ViewSalesRecordPanel() {
		...
		JButton submitBTN = new JButton("View Sales Records for this Beneficiary");
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (ut.rs.next()) {
						...
						sql = "    SELECT R.VYEAR AS \"Year\",R.SEASON as \"Season\",R.SheepSold,R.CattleSold,R.GoatSold,r.PerSoldAnimalCost\n"
